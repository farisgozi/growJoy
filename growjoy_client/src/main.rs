...
// Imports are now pointing to the growjoy_core crate
use crate::gui::add_proxy_dialog::AddProxyDialog;
use crate::gui::proxy_list::ProxyList;
use crate::gui::settings::Settings;
use growjoy_core::manager::bot_manager::BotManager;
use growjoy_core::manager::proxy_manager::ProxyManager;
use crate::texture_manager::TextureManager;
use growjoy_core::types;
use growjoy_core::utils::config;
